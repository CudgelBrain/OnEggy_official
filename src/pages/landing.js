      ...
      >
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <nav className="py-4 flex">
            ...
            <button className="bg-l_blue hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded-md justify-end">
              CONTACT
            </button>
          </nav>
        </div>
        <main>
          ...
          <div className="points grid grid-cols-3 gap- text-center">
            <div className=" cursor-pointer">
              <h2 className="text-4xl font-semibold hover:text-l_blue">
                For Startups
              </h2>
              <p className="mt-4 justify-left">
